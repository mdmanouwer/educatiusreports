 ...
 */
function midleton_form_system_theme_settings_alter(&$form, $form_state) {
  $form['midleton_enable_warning'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => omega_theme_get_setting('midleton_enable_warning', TRUE),
    '#weight' => -20,
  );
}
